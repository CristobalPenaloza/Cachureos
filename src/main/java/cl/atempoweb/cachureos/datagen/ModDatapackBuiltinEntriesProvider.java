...
import cl.atempoweb.cachureos.worldgen.ModBiomeModifiers;
import cl.atempoweb.cachureos.worldgen.ModConfiguredFeatures;
import cl.atempoweb.cachureos.worldgen.ModPlacedFeatures;
...
public class ModDatapackBuiltinEntriesProvider extends DatapackBuiltinEntriesProvider {
    ...
    public ModDatapackBuiltinEntriesProvider(PackOutput output, CompletableFuture<HolderLookup.Provider> registries) {
        super(output, registries, BUILDER, Set.of(Cachureos.MODID));
    }
}
